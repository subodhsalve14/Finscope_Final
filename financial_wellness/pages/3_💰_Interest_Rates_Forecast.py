# This is a copy of interest_rates_forecast.py for the multipage app structure
...
def load_rates_data():
    try:
        ...
        st.error("Interest rates data file not found.")
        return None
...
if df_rates is not None:
    ...
    st.info("Please add interest rates data to continue.")