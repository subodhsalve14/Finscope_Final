# This is a copy of gdp_forecast.py for the multipage app structure
...
if df_gdp is not None:
    ...
    expected_salary = current_salary * (1 + (avg_forecast_4q * 0.015))
    ...
    **📚 Historical Context:**
    ...
    st.info("Please add GDP data to continue.")